...
const CartProduct = ({ product, refetch }) => {
  ...
  return (
    <div className="flex flex-col gap-2 bg-white rounded-md shadow-sm">
        ...
        <div className="flex flex-col w-full font-medium">
          ...
          <div className="flex items-center gap-2 md:py-3">
            <button
              ...
              className="bg-black/90 font-medium text-white p-1 rounded-md
            ...
            <input
              type="text"
              value={Qty}
              className="px-2 rounded-lg bg-gray-100 font-semibold text-center font-mono text-xl py-1 w-14 h-12  "
            />
            <button
              onClick={() => decrement_Qty(product._id)}
              className="bg-black/90 text-white flex items-center justify-center p-1 rounded-md
              transition duration-100 transform active:scale-95 ease-in-out
              "
            >
              <BiMinus fontSize={18} />
          ...
          <div className="max-md:hidden flex gap-4  w-10/12">
            <div>
              <p>total qty * 100 = 100</p>
            </div>
            <button
      ...
      <div className="md:hidden flex border-b items-center justify-between px-3 py-2">
        <div>
          <p>100 * 3qty = 5000</p>
        </div>
        <button
          to={"/payment"}
          className="border-black border-2 font-medium text-sm  px-8 rounded-full py-2
