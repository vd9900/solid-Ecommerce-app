  ...
  return (
    <div className="flex flex-col gap-2 bg-white rounded-md shadow-md">
        ...
        <div className="flex flex-col w-full font-medium">
          ...
          <div className="flex items-center gap-2 md:py-3">
            <button
              ...
              className="bg-black/10 font-medium  p-1 rounded-full
            ...
            <button
              ...
              className="bg-black/10  flex items-center justify-center p-1 rounded-full
              transition duration-100 transform active:scale-95 ease-in-out
              "
            >
              <BiMinus fontSize={18} />
      ...
      <div className="md:hidden flex border-b items-center justify-between px-3 py-2">
        ...
        <button
          to={"/payment"}
          className=" border font-medium text-sm  px-8 rounded-full py-2
          transition duration-200 transform active:scale-95 ease-in-out flex items-center
          "
          type="button"
          onClick={() => handleCartDelete(product?._id)}
        >
