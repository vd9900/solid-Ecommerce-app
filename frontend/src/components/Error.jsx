      ...
      <div className="w-10/12 text-center">
        <div className="text-center flex items-center justify-center flex-col py-3">
          <img
            ...
            className="w-44"
          />
          <p className="text-2xl font-serif font-medium">Oops!</p>
          <p className="text-xl font-serif font-medium py-1">
            Something went worng.
          </p>
          <p className="text-gray-600 text-sm">
            Sometimes everthing is going wrong for the right reasons.
          </p>
        </div>
        <button
