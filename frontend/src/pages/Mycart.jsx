  ...
  return (
    <div className="max-w-screen bg-gray-50 min-h-screen">
      ...
      <div className="pt-16 pb-4 flex flex-col gap-3">
        <div className="">
          <p className="px-3 font-serif font-semibold text-xl">My cart</p>
        </div>
          ...
          <div className="md:w-8/12 w-full">
            <div className=" md:mx-auto flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3 bg-white">
                <div className="flex py-4 gap-2">
                  ...
                  <div className="flex flex-col">
                    {/* product details */}
                    <p>new waterproof and best phone</p>
                    ...
                    <div className="py-1 flex items-center gap-3">
                      ...
                      <span className="font-semibold text-xl">₹499</span>
                    </div>
                    <div className="flex items-center gap-2 py-2">
                      <button className="bg-black text-white p-1 rounded-md">
                        <MdOutlineAdd fontSize={22} />
                      </button>
                      <input
                        type="text"
                        value={2}
                      ...
                      />
                      <button className="bg-black text-white flex items-center justify-center p-1 rounded-md">
                        <BiMinus fontSize={22} />
                      </button>
                    </div>
                    ...
                    <div className="max-md:hidden flex gap-4 ">
                      ...
                      <button className="hover:bg-black hover:text-white duration-500 flex items-center  text-sm  font-semibold border rounded-full justify-center  grow  w-6/12 py-2">
                ...
                <div className="md:hidden flex border-t ">
                  ...
                  <button className="flex items-center  text-sm text-gray-600 font-semibold justify-center  grow py-3 w-6/12">
                    remove
                  </button>
                </div>
              </div>
              ...
              <div className="flex md:hidden p-2 bg-white justify-between items-center">
                ...
                <button className="flex rounded-sm gap-1 text-lg font-semibold text-white items-center w-5/12 py-2 px-2 justify-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
                  Place order
            ...
            <div>
              <div className="py-3 border-b">
                <p className="px-3 font-serif font-medium text-xl">
                  Save for later (4)
                </p>
              </div>
              <div className="flex flex-col gap-3 bg-white">
