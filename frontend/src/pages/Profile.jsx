...
const Profile = () => {
  ...
  const { user, isAuth } = useSelector((state) => state.userInfo);
            ...
            <div>
              ...
              <div className="px-4 flex flex-col gap-3">
                <div className="p-2">
                  ...
                  <input
                    type="text"
                    className="border bg-transparent outline-none py-1 w-full sm:w-6/12 px-3 rounded-sm "
                    name="username"
          ...
          <div className="sm:w-4/12 px-6 flex flex-col  items-center justify-evenly">
            <div className="flex flex-col gap-5 w-full">
              <img
                ...
                alt=""
              />
              <p className="text-3xl py-2 mr-auto"> {userData?.username}</p>
            </div>
            <button
